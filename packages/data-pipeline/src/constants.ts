...
export const FIELD_ALIASES = {
  ...
  optionA: ["odp a", "odpowiedz a", "odpowiedź a", "answer a", "option a"],
  optionB: ["odp b", "odpowiedz b", "odpowiedź b", "answer b", "option b"],
  optionC: ["odp c", "odpowiedz c", "odpowiedź c", "answer c", "option c"],
  optionAUa: [
    "odpowiedz a ua",
    "odpowiedź a ua",
    "odpowiedz a [ua]",
