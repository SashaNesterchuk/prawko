...
| `home_first_start_spotlight_starts_training.yaml` | First-start spotlight (`FIRST_START`) → 10-question untimed Quick check (`initial_diagnostic`, not exam / Training) |
