  ...
  return (
    <main className="page">
      <section className="hero hero-grid">
        <div>
          <p className="eyebrow">
            Prawko Lab · <Link href="/">back to public site</Link>
          </p>
          <h1>Local Auth And Catalog Check</h1>
          <p className="copy">
            This playground keeps the real Supabase auth and RLS smoke test for
            local development. Sign in, then verify that authenticated access
            can read the Category B question catalog.
          </p>
        </div>
          ...
          <div className="sample-list">
            {catalogState?.questions.length ? (
              ...
              <p className="copy compact">
                ...
                panel is still the fastest local proof that auth and catalog
                access are wired correctly.
              </p>
            )}
          </div>
        </article>
